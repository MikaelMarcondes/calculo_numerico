...
double runge_kutta_fehlberg(double k[6], double t_n, double y_n, double h){
    double k[1], k[2], k[3], k[4], k[5], k[6];
    k[1]=h*f(t_n, y_n);
    k[2]=h*f(t_n+(h/4), y_n+(k[1]/4));
    k[3]=h*f(t_n+(3*h/8), y_n+(3*k[1]/32)+(9*k[2]/32));
    k[4]=h*f(t_n+(12*h/13), y_n+(1932*k[1]/2197)-(7200*k[2]/2197)+(7296*k[3]/2197));
    k[5]=h*f(t_n+h,y_n+(439*k[1]/216)-8*k[2]+(3680*k[3]/513)-(845*k[4]/4104));
    k[6]=h*f(t_n+(h/2),y_n-(8*k[1]/27)+2*k[2]-(3544*k[3]/2565)-(1859*k[4]/4104)-(11*k[5]/40));
